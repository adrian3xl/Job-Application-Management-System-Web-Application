...
namespace JobApp_Web_.Data.Migrations
{
    ...
    [Migration("20200318152835_addapplicationdetailstable")]
    partial class addapplicationdetailstable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobApp_Web_.Data.Vacancy_Application", b =>
                {
                    ...
                    b.Property<string>("Jobseeker_requestId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("Jobseeker_request_id")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("Jobseeker_requestId");
            ...
            modelBuilder.Entity("JobApp_Web_.Data.Vacancy_Application", b =>
                {
                    b.HasOne("JobApp_Web_.Data.Jobseeker", "Jobseeker_request")
                        .WithMany()
                        .HasForeignKey("Jobseeker_requestId");
